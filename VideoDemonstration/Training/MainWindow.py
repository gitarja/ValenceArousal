...
class VideoPlayer(QThread):
    ...
    def __init__(self, parent=None, video_file=None, results_file=None, time_start=0, time_end=0):
        self.video_file = video_file
        self.results = pd.read_csv(results_file)
        self.results = self.results[(self.results["time"] >= time_start) & (self.results["time"] <= time_end)]
        # self.results = self.results[self.results["VideoIdx"] == video_idx]
        self.time = self.results["time"].values
...
class Ui_MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None, video_file=None, results_file=None, time_start=0, time_end=0):
        ...
        self.setupUi(self)
        self.setUpGraph()
        video_player = VideoPlayer(self, video_file, results_file, time_start, time_end)
