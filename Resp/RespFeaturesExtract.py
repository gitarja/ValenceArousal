...
resp_data = pd.read_csv(path + 'Resp\\A6-2020-10-27_Resp.csv', header=0, skiprows=[1])
resp_data["RESP_Timestamp_Unix_CAL"] = resp_data["RESP_Timestamp_Unix_CAL"].apply(utcToTimeStamp)
