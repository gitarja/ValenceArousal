...
jmi_ar_flatten = jmi_ar.values.flatten("F")
jmi_val_flatten = jmi_val.values.flatten("F")

jmi_ar_flatten = jmi_ar_flatten[~np.isnan(jmi_ar_flatten)]
jmi_val_flatten = jmi_val_flatten[~np.isnan(jmi_val_flatten)]

jmi_coeff = np.concatenate([jmi_ar_flatten, jmi_val_flatten])
